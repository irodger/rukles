...
<head>
	...
	<link rel="stylesheet" href="css/style.less.css?v0.7.2" />
...
<body>
	...
	<div class="container-fluid">
		<div class="col-md-4 text-center header">
			<a href="/"><img src="img/logo.png" alt="Руклес - создание любых персонажей без регистрации и смс"></a>
		...
		<div class="col-md-8 filter-i text-center">
			<ul class="list-inline filter-i-list filters">
				<li class="start">
					<a href="/?f=start" class="filter-i-list__link">
						<figure class="filter-i-list__f filter-i-list__f_start" title="Начальный уровень"></figure>
						<div class="filter-i-list__caption">Начальный</div>
					</a>
				</li>
				<li class="fy">
					<a href="/?f=fy" class="filter-i-list__link">
						<figure class="filter-i-list__f filter-i-list__f_fy" title="Фэнтэзи"></figure>
						<div class="filter-i-list__caption">Фэнтэзи</div>
					</a>
				</li>
				<li class="rl">
					<a href="/?f=rl" class="filter-i-list__link">
						<figure class="filter-i-list__f filter-i-list__f_rl" title="Реализм"></figure>
						<div class="filter-i-list__caption">Реализм</div>
					</a>
				</li>
				<li class="fk">
					<a href="/?f=fk" class="filter-i-list__link">
						<figure class="filter-i-list__f filter-i-list__f_fk" title="Фантастика"></figure>
						<div class="filter-i-list__caption">Фантастика</div>
					</a>
				</li>
				<li class="hr">
					<a href="/?f=hr" class="filter-i-list__link">
						<figure class="filter-i-list__f filter-i-list__f_hr" title="Ужастики"></figure>
						<div class="filter-i-list__caption">Ужастики</div>
					</a>
				</li>
				<li class="wow">
					<a href="/?f=wow" class="filter-i-list__link">
						<figure class="filter-i-list__f filter-i-list__f_wow" title="World of Warcraft"></figure>
						<div class="filter-i-list__caption">Warcraft</div>
					</a>
				</li>
				<li class="sw">
					<a href="/?f=sw" class="filter-i-list__link">
						<figure class="filter-i-list__f filter-i-list__f_sw" title="Star Wars"></figure>
						<div class="filter-i-list__caption">Star Wars</div>
					</a>
				</li>
				<li class="all">
					<a href="/?f=all" class="filter-i-list__link">
						<figure class="filter-i-list__f filter-i-list__f_all" title="Все варианты"></figure>
						<div class="filter-i-list__caption">Все</div>
					</a>
				</li>
			</ul>
		</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="row">
						...
						<div class="second-set col-md-12" id="advance">
	...
	<div class="tutorial hidden-xs">
		...
		<div class="tut b">
			...
			<div>
				<p>Тут у нас сортировка Руклеса, выбрав один из значков, Руклес будет генерировать только из выбранной категории. Советую выбирать ужастики ;-)</p>
		...
		<div class="tut c">
			...
			<div>
				<p>Тут раньше была шестеренка с настройками, но она не пользовалась популярностью и мы ее выпилили.</p>
